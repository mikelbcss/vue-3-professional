          ...
          <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
              ...
              <div class="max-h-[400px] overflow-y-auto">
                <CodeBlock v-if="leftCode" :code="leftCode" language="vue" />
                <div v-else class="text-muted-foreground p-4 border rounded">Cargando código...</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'right'" class="space-y-6">
          <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
              <h4 class="text-lg font-semibold text-foreground">💻 Código Fuente</h4>
              <div class="max-h-[400px] overflow-y-auto">
                <CodeBlock v-if="rightCode" :code="rightCode" language="vue" />
                <div v-else class="text-muted-foreground p-4 border rounded">Cargando código...</div>
              </div>
            </div>
          </div>
